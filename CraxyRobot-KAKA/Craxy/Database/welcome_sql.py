...
from Craxy.Handlers.msg_types import Types
from Craxy.Database import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. EverCraxy, look busy!",
    ...
    "EverCraxy stop what you’re doing, We are now in the presence of {first}.",
