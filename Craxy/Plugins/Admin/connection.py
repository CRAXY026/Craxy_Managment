...
import Craxy.Database.connection_sql as sql
from Craxy import dispatcher, INSPECTOR, DEV_USERS
from Craxy.Handlers import validation
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want everCraxy to see; This is where connections come in...
