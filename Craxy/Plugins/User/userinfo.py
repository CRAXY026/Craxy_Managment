...
from Craxy.__help__ import STATS, USER_INFO
import Craxy.Database.userinfo_sql as sql
from Craxy.Plugins.disable import DisableAbleCommandHandler
from Craxy.Database.global_bans_sql import is_user_gbanned
from Craxy.Database.afk_sql import is_afk, check_afk_status
from Craxy.Database.users_sql import get_user_num_chats
from Craxy.Handlers.validation import sudo_plus, user_admin, support_plus
from Craxy.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'Craxy Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Craxy_Updates">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Craxy_Updates)
"""
__mod_name__ = "Infos"
