...
from Craxy.Handlers.validation import is_user_admin
...
def start(update: Update, context: CallbackContext):
    ...
    [
        ...
        InlineKeyboardButton(
            text="Bot Info", callback_data="Craxy_"
        ),
    ],
    [
...
def Craxy_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
    query = update.callback_query
    if query.data == "Craxy_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                   [
                     InlineKeyboardButton(text="Support", url="t.me/Craxy_Support"),
                     InlineKeyboardButton(text="News", url="t.me/Craxy_Updates"),
                   ],
                   [
                    InlineKeyboardButton(text="Back", callback_data="Craxy_back")
                   ]
                ]
            ),
        )
    elif query.data == "Craxy_back":
        query.message.edit_text(
                PM_START_TEXT.format(
                        escape_markdown(first_name), escape_markdown(context.bot.first_name)),
                reply_markup=InlineKeyboardMarkup([
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Craxy_about_callback, pattern=r"Craxy_", run_async=True)
